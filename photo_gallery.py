...
class GirlGallery:
    ...
    PERSONAL_FILES = {
        "chuchu": {
            ...
            "height": "158 см",
            "weight": "48 кг",
            "hobby": "косплэй, аниме, танцы",
            "likes": "косплэй, сладости, рамен, Pokémon",
            "dislikes": "Одиночество, грубость",
            "personality": "Весёлая, энергичная, немного капризная, обожает внимание",
            "dream": "Стать известной косплэй-моделью и объездить весь мир",
        ...
        "ki": {
            ...
            "height": "150 см",
            "weight": "42 кг",
            "hobby": "Рисование, чтение, косплэй",
